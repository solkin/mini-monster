...
public class SwitchersAdapter extends BaseAdapter {
    ...
    private void bindView(View view, int position) {
        ...
        if (switcher != null) {
            TextView switcherTitle = view.findViewById(R.id.switcher_title);
            TextView switcherPort = view.findViewById(R.id.switcher_port);
            final SwitchCompat switcherToggle = view.findViewById(R.id.switcher_toggle);
            ImageView switcherIcon = view.findViewById(R.id.switcher_icon);
    ...
    public interface PortSwitchListener {
        void onPortSwitched(int port, boolean isChecked);
    }
}
